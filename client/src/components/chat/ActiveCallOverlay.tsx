...
export function ActiveCallOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950 flex flex-col overflow-hidden">
      ...
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 p-4 sm:p-8 z-10 flex flex-col items-center bg-linear-to-b from-black/60 to-transparent">
      ...
      {/* Controls */}
      <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-8 z-10 flex items-center justify-center gap-4 sm:gap-6 bg-linear-to-t from-black/80 to-transparent">
        <button
